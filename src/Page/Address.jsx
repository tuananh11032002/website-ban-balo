  ...
  return (
    <>
      ...
      <Container>
        <h1>CỬA HÀNG</h1>{" "}
        <p>
          Hãy ghé thăm cửa hàng của Camelia Brand để xem trực tiếp các sản phẩm
          nhé!
        </p>{" "}
        Hệ thống cửa hàng Camelia Brand:
        ...
        <p>
          Chi nhánh 1 tại HCM: 71 Trần Quang Diệu, Phường 14, Quận 3, TP Hồ Chí
          Minh.
        </p>
        <img
        ...
        <p>
          ...
          về sản phẩm/dịch vụ của Camelia Brand, hãy liên hệ với chúng tôi tại
          thecameliavn@gmail.com hoặc 0909140170.
        </p>
      </Container>
      <Footer />
    </>
